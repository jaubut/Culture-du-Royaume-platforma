<template>
  <div class="container">
    <div class="row justify-content-between align-items-center py-5">
      <div class="col-12 col-md-6 pl-md-0 mb-4 mb-md-0"><img class="w-100" src="@/assets/pictures/image-540x540.png" /></div>
      <div class="col-12 col-md-5">
        <h4 class="mb-3">70$/h</h4>
        ...
        <div class="row">
          <div class="col-12 col-md-4"><button class="btn btn-primary btn-block">me rejoindre</button></div>
        </div>
      </div>
    </div>
  </div>
