...
export default async (context, inject) => {
  ...
  let api = await Prismic.api('https://cultureduroyaume.cdn.prismic.io/api/v2', options)
  ...
  if (process.client) {
    window.onNuxtReady && window.onNuxtReady(() => {
      ...
      script.src = '//static.cdn.prismic.io/prismic.min.js?repo=cultureduroyaume&new=true'
